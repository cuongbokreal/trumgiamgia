...
setTimeout(function(){ 
    ...
    surf.innerHTML = `<a class="${classTitleVouchers}" data-id="${idTitleVouchers}" href="#couponTab" title="${titleVouchers.innerText}" alt="${titleVouchers.innerText}">${titleVouchers.innerText}</a>`;
}, 5000);
