...
setTimeout(function(){ 
    ...
    var idTitleVouchers = titleVouchers.getAttribute("data-id");
    var hrefTitleVouchers = titleVouchers.getAttribute("href");
    surf.innerHTML = `<a class="${classTitleVouchers}" data-id="${idTitleVouchers}" href="${hrefTitleVouchers}" title="${titleVouchers.innerText}" alt="${titleVouchers.innerText}">${titleVouchers.innerText}</a>`;
}, 5000);
