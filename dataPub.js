...
setTimeout(function(){ 
    ...
    surf.innerHTML = `<a href="#couponTab" title="Mã tại TrumGiamGia: ${titleVouchers.innerText}" alt="Mã tại TrumGiamGia: ${titleVouchers.innerText}">${titleVouchers.innerText}</a>`;
}, 5000);
