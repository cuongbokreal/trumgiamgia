...
!function(){
  function f(){
    alert(' Opps, bạn đang dùng Ad Block, hãy tắt trình chặn quảng cáo để giúp chúng mình có thêm thu nhập! Iu bạn nhìu nhìu 😍👉👈');
      ...
      message: `&#9888;&#65039; Opps, bạn đang dùng Ad Block, hãy tắt trình chặn quảng cáo để giúp chúng mình có thêm thu nhập! Iu bạn nhìu nhìu 😍👉👈. Xem cách <a href='/p/cach-tat-adblock'><b>TẮT AD BLOCK TẠI ĐÂY</b></a>`,
      type: "error",
      duration: 999000
    });
